...
.AWS
--
La vidéo suivante montre les étapes à suivre pour s'abonner à la NetApp Console depuis AWS Marketplace :

.Abonnez-vous à la NetApp Console depuis AWS Marketplace
video::096e1740-d115-44cf-8c27-b051011611eb[panopto]
--
.Azuré
--
La vidéo suivante montre les étapes à suivre pour s'abonner à la NetApp Console depuis la Place de marché Azure :

.Abonnez-vous à la NetApp Console depuis Azure Marketplace
...
.Abonnez-vous à la NetApp Console depuis Google Cloud Marketplace
