...
. Dans le menu de la NetApp Console , sélectionnez *Administration > Licenses and subscriptions*.
. Sélectionnez *Abonnements Marketplace*.
. Dans la ligne correspondant à l'abonnement que vous souhaitez associer, ouvrez le menu Actions puis sélectionnez *Associer*.
. Dans la boîte de dialogue *Associer l’abonnement*, sélectionnez les organisations Console que vous souhaitez associer à l’abonnement.
...
. Dans le menu de la NetApp Console , sélectionnez *Administration > Licenses and subscriptions*.
. Sélectionnez *Abonnements Marketplace*.
. Sur la ligne correspondant à l'abonnement dont vous souhaitez consulter les informations d'identification, sélectionnez *Afficher*. Si plusieurs informations d'identification sont associées à un abonnement, aucune information d'identification ne peut s'afficher et vous êtes invité à sélectionner un autre agent.
...
Lorsque vous vous désabonnez d'un abonnement auprès de votre fournisseur de cloud (AWS, Google Cloud ou Azure), la Console affiche l'état de l'abonnement comme *Unsubscribed*. Lorsque vous vous êtes désabonné d'un abonnement, vous pouvez également le supprimer de Licenses and subscriptions.

.Avant de commencer
* Vous pouvez uniquement supprimer les abonnements dont le statut est *Désabonné*. Tous les paramètres, données et configurations associés doivent être effacés ou réinitialisés avant suppression.
+
Si l'abonnement est toujours configuré, l'option *Supprimer* n'est pas disponible.
...
. Dans la boîte de dialogue *Supprimer l’abonnement*, sélectionnez *Supprimer* pour confirmer que vous souhaitez supprimer l’abonnement.
