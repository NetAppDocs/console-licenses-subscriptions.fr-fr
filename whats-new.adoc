...
Vous pouvez désormais gérer les licences Cloud Volumes ONTAP via la page d'accueil ou l'onglet *Licences directes*. Utilisez l'onglet *Abonnements Marketplace* pour consulter les informations relatives à votre abonnement.
...
https://docs.netapp.com/us-en/console-setup-admin/task-monitor-cm-operations.html["Apprenez à configurer les notifications par e-mail"^]
...
https://docs.netapp.com/us-en/bluexp-digital-wallet/task-manage-capacity-licenses.html["Apprenez à changer de méthode de charge"] .
...
Le portefeuille numérique affiche désormais la capacité totale consommée sur votre compte ainsi que la capacité consommée par package de licences. Cela peut vous aider à comprendre comment vous êtes facturé et si vous devez acheter de la capacité supplémentaire.
