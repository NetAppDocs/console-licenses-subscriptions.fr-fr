...
summary: Acceptez une offre privée Marketplace pour la NetApp Console dans la console AWS et configurez les informations d’identification AWS dans la console. 
---
