...
Les informations de licence s'affichent automatiquement dans la section **Licenses and subscriptions** si le compte NetApp Console associé à la licence est également un compte NetApp Support Site. Si vous avez utilisé un compte Console qui n'est pas associé à votre compte NSS, vous devrez ajouter une licence manuellement.
