...
summary: 'Gérez les licences que vous avez achetées directement auprès de NetApp (BYOL) pour une utilisation avec les services de données NetApp. Vous pouvez consulter la capacité de licence utilisée, l"utilisation de cette capacité et les dates d"expiration à venir.' 
---
...
[role="lead"]
Vous pouvez gérer les licences que vous avez achetées directement auprès de NetApp (BYOL) pour une utilisation avec les services de données NetApp, y compris Cloud Volumes ONTAP. Vous pouvez consulter la capacité de licence utilisée, l’utilisation de la capacité et les dates d’expiration à venir.
...
* https://docs.netapp.com/us-en/data-services-backup-recovery/br-start-licensing.html["Configurer les licences pour NetApp Backup and Recovery"^]
* https://docs.netapp.com/us-en/data-services-disaster-recovery/get-started/dr-licensing.html["Configurer les licences pour NetApp Disaster Recovery"^]
* https://docs.netapp.com/us-en/data-services-ransomware-resilience/rp-start-licenses.html["Configurer les licences pour NetApp Ransomware Resilience"^]
* https://docs.netapp.com/us-en/data-services-cloud-tiering/task-licensing-cloud-tiering.html["Configurer les licences pour NetApp Cloud Tiering"^]
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html["Configurer les licences pour Cloud Volumes ONTAP"^]
...
+
.. Dans le menu de navigation de la console, sélectionnez *Administration* > *Identité et accès*.
...
Les informations de licence s'affichent automatiquement dans la section **Licenses and subscriptions** si le compte NetApp Console associé à la licence est également un compte NetApp Support Site et dispose d'un accès Internet. Si vous avez utilisé un compte Console qui n'est pas associé à votre compte NSS, vous devez ajouter une licence manuellement.
...
. Sélectionnez l'onglet *Licences directes*.
...
. Sélectionnez une ligne de nom de service pour la développer. Cela affiche toutes les licences associées à ce service. Chaque ligne développée affiche des informations détaillées sur les licences, y compris l'identifiant de licence, le numéro de série, la capacité et la date d'expiration.
