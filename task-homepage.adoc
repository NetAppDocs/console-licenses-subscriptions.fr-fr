...
[role="lead"]
Le tableau de bord *Vue d'ensemble* dans la NetApp Console vous aide à surveiller l'état de vos licences et abonnements afin de vous permettre de gérer les coûts et de maintenir le service lorsque les abonnements arrivent à expiration ou atteignent leurs limites de capacité.
...
+
Vous ne pouvez pas ajouter de nouvelles licences ou de nouveaux abonnements depuis la page *Overview* d'un service spécifique. Vous pouvez uniquement ajouter des licences depuis l'onglet *Direct licenses* ou des abonnements depuis l'onglet *Marketplace subscriptions*.
...
+
** link:task-manage-data-services-licenses.html["En savoir plus sur la gestion des licences"].
** link:task-manage-subscriptions.html["En savoir plus sur la gestion des abonnements"].
